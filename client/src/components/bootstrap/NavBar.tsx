...
const NavBar = () => {
  ...
  return (
    // <!--  BEGIN NAVBAR left: "50%", transform: "translateX(-50%)" style={{ width: "90%", left: "10px", right: "auto", marginLeft: "auto", marginRight: "auto" }} -->
    <div className="header-container container-xxl flex-grow-[8]" id="myNavbar">
      <header className="header navbar navbar-expand-sm expand-header">
        <a href="#" className="gap-1">
          ...
          <span className="ms-2">MERN ToDo</span>
        </a>

        <ul className="navbar-item flex-row ms-auto ">
          <li className="nav-item theme-toggle-item">
            <a href="#" className="nav-link theme-toggle" onClick={handleClick}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            >
              <div className="avatar-container">
                <div className="avatar avatar-sm avatar-indicators avatar-online">
                  ...
                  />
                  {/* <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="feather feather-user rounded-circle"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> */}
                </div>
              </div>
            </a>
